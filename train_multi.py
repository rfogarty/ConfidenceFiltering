...
def trainModel(args) :
    ...
    #dataIterator,labels,paths,vdataIterator,vlabels,vpaths = getTrainingAndValidation(imageProcessing,args,tensorShape)
    ...
    model = buildTrainingNet(tensorShape,numClasses(),gpuIds2Names(args.gpus),weights=initialWeights(args),augment=args.augment,trainFeatureLayers=args.trainFeatures,shrinkStages=shrinkStages)
